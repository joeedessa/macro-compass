...
const GROUPS = [
  ...
  ["sector", "Sectors"],
  ["commodities", "Commodity reference"],
  ["rates", "Rates & credit"],
  ["fx", "FX & volatility"],
];

// symbol, display name, group, kind
/* Shared list; see universe.js. Aliased because this file already
   uses UNIVERSE as its own name for it. */
const UNIVERSE = window.UNIVERSE.MARKETS;
...
const RATIOS = [
  ...
  ["SPY", "GC=F", "Equities vs gold", "Equities preferred over gold", "Gold preferred over equities"],
  ...
  ["GC=F", "STIP", "Gold vs short TIPS", "Gold outrunning real-rate protection", "Real-rate protection preferred"],
...
const CROSS = [
  { macro: "us_real_10y", mkt: "GC=F", name: "Real yields \u2192 gold",
